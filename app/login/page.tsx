...
import { Lock, Loader2, ArrowLeft, Mail, LogIn } from 'lucide-react';
      ...
      >
        ...
        <div className="bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl p-8 border border-zinc-200 dark:border-zinc-800 shadow-2xl">
          <div className="mb-10 text-center">
            ...
            <p className="text-zinc-500 dark:text-zinc-400 font-medium text-sm">Access your premium event dashboard</p>
          </div>
